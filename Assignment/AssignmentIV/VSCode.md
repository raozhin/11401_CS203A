...
* [cite_start]**GitHub Pull Requests and Issues**: Allows you to review and manage GitHub pull requests and issues directly in VS Code.
...
1.  [cite_start]Open the Command Palette (`Ctrl+Shift+P`).
2.  [cite_start]Type `GitHub: Sign in` and select the option.
3.  [cite_start]Follow the prompts to authenticate with your GitHub account.

### 3.2. Cloning the Repository

Instead of using the command line externally, I used VS Code's command palette:
1.  [cite_start]Opened the Command Palette (`Ctrl+Shift+P`).
2.  [cite_start]Typed `Git: Clone` and selected the option.
3.  [cite_start]Pasted the course repository URL when prompted.
4.  [cite_start]Selected the local destination folder where the repository will be cloned.
5.  [cite_start]Once cloned, VS Code prompted to open the repository, and I clicked `Open`.
...
2.  [cite_start]**Committing**: Entered a descriptive commit message in the message box above the staged changes and clicked the "Commit" button.
3.  [cite_start]**Pushing**: Synced changes to GitHub by clicking the "Sync Changes" button (or "Push" option in the menu) in the bottom-left status bar or in the Source Control view.
...
* **C/C++ Extension Pack (by Microsoft)**: This is essential. It includes IntelliSense (code completion), debugging features, and code browsing tools for C and C++.
* **(Optional) GitLens**: Provides deeper insights into Git history directly within the editor lines, which is very helpful for tracking changes.
* [cite_start]**GitHub Pull Requests and Issues**: Allows you to review and manage GitHub pull requests and issues directly in VS Code[cite: 2].
...
1.  **Staging**: Modified files appear under "Changes". Clicking the `+` button next to a file stages it for commit (equivalent to `git add`).
2.  [cite_start]**Committing**: Entered a descriptive commit message in the message box above the staged changes and clicked the "Commit" button (check icon).
3.  [cite_start]**Pushing**: Synced changes to GitHub by clicking the "Sync Changes" button (or "Push" option in the menu) in the bottom-left status bar or in the Source Control view.
