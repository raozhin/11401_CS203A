...
1.  [cite_start]Open the Command Palette (`Ctrl+Shift+P`)[cite: 2].
2.  [cite_start]Type `GitHub: Sign in` and select the option[cite: 2].
3.  [cite_start]Follow the prompts to authenticate with your GitHub account[cite: 2].

### 3.2. Cloning the Repository

Instead of using the command line externally, I used VS Code's command palette:
1.  [cite_start]Opened the Command Palette (`Ctrl+Shift+P`)[cite: 2].
2.  [cite_start]Typed `Git: Clone` and selected the option[cite: 2].
3.  [cite_start]Pasted the course repository URL when prompted[cite: 2].
4.  [cite_start]Selected the local destination folder where the repository will be cloned[cite: 2].
5.  [cite_start]Once cloned, VS Code prompted to open the repository, and I clicked `Open`[cite: 2].

### 3.3. Managing Changes (Source Control View)

[cite_start]I utilized the **Source Control** view (Ctrl+Shift+G) in the sidebar for version control operations[cite: 2]:
...
2.  [cite_start]**Committing**: Entered a descriptive commit message in the message box above the staged changes and clicked the "Commit" button (check icon)[cite: 2].
3.  [cite_start]**Pushing**: Synced changes to GitHub by clicking the "Sync Changes" button (or "Push" option in the menu) in the bottom-left status bar or in the Source Control view[cite: 2].
